...
-- Target scale: 5,000 members, 10,000 vehicles, 50,000 person visits, 30,000 vehicle visits
...
FROM generate_series(1, 12000) AS s(i)  -- extra to account for duplicates
